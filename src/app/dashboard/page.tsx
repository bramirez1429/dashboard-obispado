...
const cards = [
  ...
  },
  {
    ...
    value: 3,
    suffix: "activos",
    description: "Mensajes con tema, fecha y link público de referencia.",
  ...
  },
  {
    ...
    value: 2026,
    suffix: "",
    description: "Base visual para consultar minutas y discursos por año.",
    href: "/dashboard",
      ...
      <Card className="welcome-card">
        <div className="welcome-content">
          <div>
            ...
            >
              Panel para preparar la reunión sacramental.
            </Paragraph>
          </div>
